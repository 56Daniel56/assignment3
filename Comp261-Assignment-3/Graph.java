...
public class Graph {
    ...
    public Graph(Map<String,City> cities, Collection<Edge> originalEdges) {
        ...
        //nodes connected by single edge, directed graph.
        //nodes represent cities
        //edges represent how many people can travel between them per hour

        //create residiual graph structure in which every regular  edge has a back reverse
        //edge stored at index i+1.
